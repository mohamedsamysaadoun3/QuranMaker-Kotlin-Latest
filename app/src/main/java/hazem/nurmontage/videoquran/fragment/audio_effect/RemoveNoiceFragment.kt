...
class RemoveNoiceFragment : Fragment {
    ...
    companion object {
        ...
        fun getInstance(
            ...
            if (instance == null) {
                instance = RemoveNoiceFragment(iEditMediaCallback, entityAudio)
            }
            return instance!!
        }
    }
    ...
    override fun onCreateView(
        ...
        switchCompat.isChecked = entityAudio!!.effectAudio.isRemoveNoice
    ...
    private fun apply(applyAll: Boolean) {
        ...
        effectAudio.isRemoveNoice = btn_remove_noice?.isChecked ?: false
        ...
        iEditMediaCallback?.let {
            if (applyAll) {
                it.updateEntity(EffectAudioType.NOICE, entityAudio!!)
